...
frame1.Peggy_RefreshAll(1); //Draw frame buffer 1 time
frame2.Peggy_RefreshAll(2); //Draw frame buffer 2 times
frame3.Peggy_RefreshAll(4); //Draw frame buffer 4 times
frame4.Peggy_RefreshAll(8); //Draw frame buffer 8 times
}
